...
{
	var intTotal = 0;
	arySuspendData = doLMSGetValue("cmi.suspend_data");
	if(arySuspendData.indexOf(",") != -1)
	{
		arySuspendData = arySuspendData.split(",")
		for(i=0; i < arySuspendData.length ;i++)
		{
				//alert(arySuspendData[i]);
				intTotal += parseInt(arySuspendData[i]);
		}
		//alert(intTotal);
